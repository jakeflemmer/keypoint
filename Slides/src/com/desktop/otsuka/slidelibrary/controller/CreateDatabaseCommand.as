package com.desktop.otsuka.slidelibrary.controller
{
	...
	public class CreateDatabaseCommand
	{
		...
		*sections*
		...
		section_id  	  -- change to id
		section_name	 
		sequence 	 
		
		// section_in_presentation_id  - not created 		
		presentation_id		 
		is_sequential ??
		*slides*
		...
		bundle_id
		bundle_position
		is_locked		-- change to locked_to_section    -- not used anywhere
		is_mandatory	
		section_slide_id		
		sequence 
		slide_id  
		...
		NO NO NO!! me dont want below tables
		optional_slides
		====================================================================================================
